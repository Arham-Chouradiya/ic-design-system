...
{/* TODO: copy the way in which the code files display the examples */}
{/* TODO: Cypress only available in react, change function of stackblitz or codepreview? */}
{/* TODO: Stackblitz TestCodePreview will need to differentiate between cypress/jest and RTL */}
{/* //? There is no short and long code. only long code. How to display this in the code preview? */}
{/* //? Open stackblitz with a react component and cypress test file */}

export const snippetsDefault ={
    name: "Textfield.cy.tsx",
    code: {
      shortCode: `it("renders", () => {
  ...
  it("takes a value in the textfield and prints to console when the button is clicked", () => {
    ...
    cy.get("@consoleLog").should(
      ...
      longCode: `import React, { useState } from "react";
...
describe("IcTectField in a form", () => {
  ${shortCode}
});`
    },
  }
